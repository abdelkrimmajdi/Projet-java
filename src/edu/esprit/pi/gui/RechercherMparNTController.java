 ...
 * @author hamma
 */
public class RechercherMparNTController implements Initializable {
    ...
    private final ServiceMatch service = new ServiceMatch();
    ...
    private void selection(MouseEvent event) {
        Match clickedTournoi = tableDB.getSelectionModel().getSelectedItem();
