...
public class RechercherTparAdresseController implements Initializable {
    ...
    private void selection(MouseEvent event) {
        ...
        if (clickedTournoi != null) {
            txtAdresse.setText(clickedTournoi.getAdresse());
