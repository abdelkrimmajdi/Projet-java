...
public class TournoiController implements Initializable {
    ...
    private void modifier(ActionEvent event) {
        try {
            Parent root =  FXMLLoader.load(getClass().getResource("ModifierTournoi.fxml"));
    ...
    private void supprimer(ActionEvent event) {
        try {
            Parent root =  FXMLLoader.load(getClass().getResource("SupprimerTournoi.fxml"));
